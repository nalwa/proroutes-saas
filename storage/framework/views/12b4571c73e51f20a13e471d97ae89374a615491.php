...
<spark-register-stripe inline-template>
    <div>
        <div class="spark-screen container">
            ...
            <?php echo $__env->make('spark::auth.register-common', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form">
                                ...
                                <?php if(Spark::collectsBillingAddress()): ?>
                                    ...
                                    <?php echo $__env->make('spark::auth.register-address', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <!-- Plan Features Modal -->
        <?php echo $__env->make('spark::modals.plan-details', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
</spark-register-stripe>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('spark::layouts.app', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>